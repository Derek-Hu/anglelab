...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"/home/nb073/workspaces/anglelab/www/js/app.js\""); }());
...
/***/ function(module, exports) {
	...
	/** */function (module, exports, __webpack_require__) {
				...
				var routers = __webpack_require__(!function webpackMissingModule() {
							var e = new Error('Cannot find module "./pages"');e.code = 'MODULE_NOT_FOUND';throw e;
				}());
				var LocalStorageModule = __webpack_require__(2);
				...
				(function (window, angular) {
							...
							angular.module('LocalStorageModule', []).provider('localStorageService', function () {
										...
										this.$get = ['$rootScope', '$window', '$document', '$parse', '$timeout', function ($rootScope, $window, $document, $parse, $timeout) {
													...
													var underiveQualifiedKey = function underiveQualifiedKey(key) {
																return key.replace(new RegExp('^' + prefix, 'g'), '');
													};

													// Check if the key is within our prefix namespace.
													var isKeyPrefixOurs = function isKeyPrefixOurs(key) {
													...
													var addToLocalStorage = function addToLocalStorage(key, value, type) {
																setStorageType(type);
													...
													var getFromLocalStorage = function getFromLocalStorage(key, type) {
																setStorageType(type);
													...
													//
													var removeFromLocalStorage = function removeFromLocalStorage() {
													...
													var getKeysForLocalStorage = function getKeysForLocalStorage(type) {
																setStorageType(type);
													...
													var clearAllFromLocalStorage = function clearAllFromLocalStorage(regularExpression, type) {
																setStorageType(type);
													...
													var addToCookies = function addToCookies(key, value, daysToExpiry, secure) {
	                      ...
	                      * (allows developer to mix and match secure + non-secure) */
	                            ...
	                            * add the secure attribute to the cookie (after domain) */
													...
													var setStorageType = function setStorageType(type) {
													...
													var bindToScope = function bindToScope(scope, key, def, lsKey, type) {
																lsKey = lsKey || key;
													...
													var lengthOfLocalStorage = function lengthOfLocalStorage(type) {
																setStorageType(type);
